...
class Uav:
    ...
    def __init__(self, uid, startPos, endPos, totalFlightTime=0, waypointTime=0, waypointX=0, waypointY=0, waypointZ=0,linearMobilityFlag=False,splineMobilityFlag=False):
        self._uid = uid
